...
// @version      0.2.2
// @description  Fixed InfoPanel disappearance + Watchdog + PCS-8 v3.2 compliance
...
(function PANEL_VERSION_V9(){
 ...
 if(panel){
  ...
  ver.textContent='Сборка: app102 v0.2.2';
  ver.style.fontSize='12px';
  ver.style.color='#ccc';
  panel.appendChild(ver);
  console.log('[INFO] Panel version updated → app102 v0.2.2');
 }
})();
...
const CandleChartUI = (() => {
  ...
  function createPanel(){
    if (document.getElementById('candle-chart-controls')) return;
    if (document.querySelector('#graphs #candle-chart-canvas')) return;
  ...
  const __CANDLE_UI_INTERVAL_ID = setInterval(draw,1000);
